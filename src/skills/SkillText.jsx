...
const SkillText = () => {
  return (
    <div className='pt-3'>
     ...
     <h1 className='p-2 border rounded-xl bg-slate-200 w-[75px] h-[28px] justify-center items-center flex size-3  md:w-[200px] md:h-[50px] md:text-xl md:rounded-full md:mb-10 text-black'>Skills</h1> 
     </div>
