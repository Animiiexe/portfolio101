...
const FirstProject = () => {
  ...
  const techStack = ["React", "Node.js", "MongoDB", "Tailwind CSS", "Socket.io", "OpenAI API"]
        ...
        <div className="relative backdrop-blur-xl bg-white/10 border border-blue-600/30 rounded-2xl p-6 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 min-h-[650px] flex flex-col">
              ...
              {slides.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${
                    index === currentIndex ? "bg-blue-500 w-6" : "bg-white/30 hover:bg-white/50"
                  }`}
                />
              ))}
            </div>
          ...
          >
            <p className="leading-relaxed mb-3">
              Yapster is an AI-enhanced chat app that revolutionizes real-time communication with intelligent features
